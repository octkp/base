--[[
  kickstart.nvim ベースの設定
  カスタマイズ: catppuccin, neo-tree, PHP/Go/TS LSP
--]]
...
require('lazy').setup({
  ...
  -- mini.nvim（テキストオブジェクト、surround、ステータスライン）
  {
    'nvim-mini/mini.nvim',
    config = function()
  ...
  -- Treesitter
  {
    ...
    branch = 'main',
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'php', 'go', 'javascript', 'typescript', 'json', 'yaml', 'css', 'nix' }
