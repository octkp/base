...
SET
    ...
    company_is_unsubscribed = current_setting('v.is_unsubscribed')::int,
    company_unsubscribe_scheduled_at = current_setting('v.unsubscribe_scheduled_at')::date
WHERE company_id = current_setting('v.company_id')::int
RETURNING
    company_id,
    company_name,
