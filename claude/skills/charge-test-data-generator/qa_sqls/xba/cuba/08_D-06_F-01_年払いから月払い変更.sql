-- SQL No: 08
-- パターン: D-06 + F-01
-- 目的: 年払い→月払い変更予約後、契約満了の状態を作成
-- 検証目的: 月払いへの切替処理確認
-- 対象テーブル: companies, charges, charge_items
-- 環境: cuba7
-- 備考: 123566220（年払いONのまま→月払いになる）, 123573857（年払いOFF→月払いになる）

-------------------------------
-- 変数設定
-------------------------------
-- 1企業目: 年払いONのままパターン
SET v.company_id = '123566220';
...
-------------------------------
-- 3. 2企業目の処理: 年払いOFFパターン
-------------------------------
SET v.company_id = '123573857';
-- 年払いOFFパターンは年払いOFF設定が必要
