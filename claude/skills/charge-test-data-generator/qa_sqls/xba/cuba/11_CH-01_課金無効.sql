-- SQL No: 11
-- パターン: CH-01
-- 目的: 年払い契約満了月＋課金無効の状態を作成
-- 検証目的: 課金無効時に契約更新確認メールが送信されないこと
...
SET v.charge_period_end_date = '2026-01-31';    -- 契約期間終了日（12ヶ月後の月末）
SET v.is_charge_target = '0';                   -- 課金対象外（課金無効）
...
-- 2-5. companies更新（is_charge_target = 0 で課金無効）
UPDATE companies
SET
